...
Route::get('category/{category}','ProductController@indexCategory');
Route::get('category/product/{id}','ProductController@index');
Route::post('/review/{id}','ProductController@store');
